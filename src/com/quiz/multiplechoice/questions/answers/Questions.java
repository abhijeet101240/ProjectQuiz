...
public class Questions {
	...
	public Questions(String question, String opt_1, String opt_2, String opt_3, String opt_4) {
		super();
		Question = question;
		this.opt_1 = opt_1;
		this.opt_2 = opt_2;
	...
	public String toString() {
		return "Questions [Question=" + Question + ", opt_1=" + opt_1 + ", opt_2=" + opt_2 + ", opt_3=" + opt_3
				+ ", opt_4=" + opt_4 + "]";
	}
